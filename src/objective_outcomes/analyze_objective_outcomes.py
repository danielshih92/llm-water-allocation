...
from adaptation_dynamics.plot_adaptation_dynamics import (  # noqa: E402
    CONDITION_ORDER,
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "compare_result" / "objective_outcomes"
...
def main() -> None:
    ...
    manifest = {
        ...
        "input": str(args.replay_details.resolve()),
