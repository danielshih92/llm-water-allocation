...
if os.path.exists("temp_backend_config.json"):
    ...
    AGENT_BACKENDS = {
        ...
        "Bob": {"backend": "openai", "model": "gpt-5.4-nano", "temperature": 0.6},
        "Cindy": {"backend": "gemini", "model": "gemini-2.5-flash", "temperature": 0.6},
        "David": {"backend": "gemini", "model": "gemini-3.1-flash-lite-preview", "temperature": 0.6},
