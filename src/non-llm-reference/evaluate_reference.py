...
DEFAULT_ORIGINAL = PROJECT_ROOT / "compare_result" / "main_table" / "replay_details.csv"
DEFAULT_OUTPUT = PROJECT_ROOT / "compare_result" / "non-llm-reference"
...
def main() -> None:
    ...
    write_json(output_dir / "run_config.json", {
        ...
        "input_batches": {"OF": str(of_dir), "OPF": str(opf_dir)},
        "original_replays": str(original_path),
