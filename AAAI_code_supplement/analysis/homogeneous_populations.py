...
def main() -> None:
    ...
    parser.add_argument(
        "--log-dir",
        type=str,
        default=os.path.join(_project_root(), "data", "paper_intermediates", "homogeneous", "logs"),
        help="Root directory containing homogeneous-population batch folders.",
    )
    parser.add_argument(
        "--batch",
        action="append",
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Output folder. Defaults to outputs/homogeneous_populations.",
    )
    parser.add_argument(
        "--output-prefix",
        type=str,
    ...
    output_dir = args.output_dir or os.path.join(
        _project_root(), "outputs", "homogeneous_populations"
    )
