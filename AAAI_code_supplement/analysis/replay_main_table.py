...
DEFAULT_OUTPUT = PROJECT_ROOT / "outputs" / "main_table"
...
def main():
    ...
    report = {
        "of_batch": package_relative(args.of_dir),
        "opf_batch": package_relative(args.opf_dir),
        "seeds": args.seeds,
