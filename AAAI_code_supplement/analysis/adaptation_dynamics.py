...
DEFAULT_OF_BATCH = PROJECT_ROOT / "data" / "paper_intermediates" / "logs" / "OF"
DEFAULT_OPF_BATCH = PROJECT_ROOT / "data" / "paper_intermediates" / "logs" / "OPF"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "outputs" / "adaptation_dynamics"
...
def main() -> None:
    ...
    if args.input_mode == "replay":
        ...
        input_source = package_relative(args.replay_details)
    else:
        rows_by_condition = {
    ...
    manifest = {
        ...
        "of_batch": package_relative(args.of_batch),
        "opf_batch": package_relative(args.opf_batch),
