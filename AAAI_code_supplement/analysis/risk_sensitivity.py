...
DEFAULT_BATCH = PROJECT_ROOT / "data" / "paper_intermediates" / "logs" / "OPF"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "outputs" / "risk_response"
            ...
            for record in iter_records(meta_round_file):
                ...
                for agent in agents if isinstance(agents, list) else []:
                    ...
                    metadata = {
                        ...
                        "meta_round_file": package_relative(meta_round_file),
                    }
