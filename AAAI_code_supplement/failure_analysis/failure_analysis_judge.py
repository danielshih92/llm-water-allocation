...
from failure_analysis.pipeline import run_failure_analysis


DEFAULT_LOG_DIR = os.path.join(PROJECT_ROOT, "data", "paper_intermediates", "logs")
DEFAULT_OUTPUT_DIR = os.path.join(PROJECT_ROOT, "outputs", "failure_analysis")
DEFAULT_BATCHES = [
    "OPF",
    "OF",
]
