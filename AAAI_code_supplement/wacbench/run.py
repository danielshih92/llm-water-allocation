        ...
        compact_agents.append(
            {
                ...
                "generation_stats": safe_generation_stats,
            }
        )
...
def run_experiment(
    ...
    for meta_round_id in range(
        ...
        # Distribution logs intentionally exclude model reasoning and response
        # text. The numeric validation fields and final executable policy are
        # sufficient for every packaged analysis.
        record_for_log = build_compact_meta_round_record(record)
