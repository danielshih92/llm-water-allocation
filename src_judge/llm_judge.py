...
def main() -> None:
    ...
    parser.add_argument("--condition-labels", nargs="+", required=True)
    ...
    parser.add_argument("--resume", action="store_true", help="Skip existing judged items")
    parser.add_argument("--blind-model-names", action="store_true", default=True)
